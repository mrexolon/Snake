package com.example.exolon.snake.engine;

import android.os.CpuUsageInfo;

import com.example.exolon.snake.Classes.Coordinate;
import com.example.exolon.snake.enums.Direction;
import com.example.exolon.snake.enums.GameState;
...
public class GameEngine {
    ...
    private Coordinate getShakeHead(){
        return snake.get(0);
    }
    ...
    public void Update(){
        ...
        for (int i =1 ; i < snake.size();i++){
            ...
            if (getShakeHead().equals(snake.get(i))){
                currentGameState = GameState.Lost;
                return;
            }
